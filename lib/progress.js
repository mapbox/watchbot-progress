...
function client(table) {
  console.log('Table BEFORE setting to ProgressTable: ' + table);
  ...
  console.log('dyno.TABLE: ' + table.split(':')[5].split('/')[1]);
  console.log('dyno.REGION: ' + table.split(':')[3]);
  console.log(dyno.getItem());
  /**
